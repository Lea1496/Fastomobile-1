...
public class CréateurChemin1
{
    ...
    public CréateurChemin1(int largeur)
    {
    ...
    private void CréerChemin2D(int p1, int p2, int p3, int p4)
    {
        ...
        tousPointsVisités.Add(2);
        tousPointsVisités.Add(3);
        tousPointsVisités.Add(13);
        tousPointsVisités.Add(23);
        tousPointsVisités.Add(24);
        tousPointsVisités.Add(25);
        tousPointsVisités.Add(26);
        tousPointsVisités.Add(36);
        tousPointsVisités.Add(46);
        tousPointsVisités.Add(56);
        tousPointsVisités.Add(57);
        tousPointsVisités.Add(58);
        tousPointsVisités.Add(68);
        tousPointsVisités.Add(78);
        tousPointsVisités.Add(88);
        tousPointsVisités.Add(87);
        tousPointsVisités.Add(86);
        tousPointsVisités.Add(85);
        tousPointsVisités.Add(84);
        tousPointsVisités.Add(83);
        tousPointsVisités.Add(82);
        tousPointsVisités.Add(81);
        tousPointsVisités.Add(80);
        tousPointsVisités.Add(70);
        tousPointsVisités.Add(60);
        tousPointsVisités.Add(50);
        tousPointsVisités.Add(40);
        tousPointsVisités.Add(30);
        tousPointsVisités.Add(20);
        tousPointsVisités.Add(10);
